...
class CategorySuggestionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'category_suggestions' => '\OpenAPI\Client\Model\CategorySuggestion[]',
     ...
     *
     * @return \OpenAPI\Client\Model\CategorySuggestion[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CategorySuggestion[]|null $category_suggestions Contains details about one or more suggested categories that correspond to the provided keywords. The array of suggested categories is sorted in order of eBay's confidence of the relevance of each category (the first category is the most relevant).<br /><br /><span class=\"tablenote\"> <strong><span style=\"color:red\">Important:</span></strong> This call is not supported in the Sandbox environment. It will return a response payload in which the <b>categoryName</b> fields contain random or boilerplate text regardless of the query submitted. </span>
     *
     * @return self
     */
