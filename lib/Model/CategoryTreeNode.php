...
class CategoryTreeNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'child_category_tree_nodes' => '\OpenAPI\Client\Model\CategoryTreeNode[]',
     ...
     *
     * @return \OpenAPI\Client\Model\CategoryTreeNode[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CategoryTreeNode[]|null $child_category_tree_nodes An array of one or more category tree nodes that are the immediate children of the current category tree node, as well as their children, recursively down to the leaf nodes.    <br /><br /><i>Returned only if</i> the current category tree node is not a leaf node (the value of <b>leafCategoryTreeNode</b> is <code>false</code>).
     *
     * @return self
     */
