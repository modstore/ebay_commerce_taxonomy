...
## Generating
Download the contract from: https://developer.ebay.com/api-docs/commerce/taxonomy/static/overview.html
Open API generator https://openapi-generator.tech/

Brew command to run:
```shell
openapi-generator generate -i commerce_taxonomy_v1_oas3.json -g php -o ebay_commerce_taxonomy
```